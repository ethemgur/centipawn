...
class Board {
  ...
  static const standard = Board(
    occupied: SquareSet((0xffff0000 << 32) | 0x0000ffff),
    promoted: SquareSet.empty,
    white: SquareSet(0xffff),
    black: SquareSet(0xffff000000000000),
    pawns: SquareSet(0x00ff00000000ff00),
    knights: SquareSet((0x42000000 << 32) | 0x00000042),
    bishops: SquareSet((0x24000000 << 32) | 0x00000024),
    rooks: SquareSet.corners,
    queens: SquareSet((0x08000000 << 32) | 0x00000008),
    kings: SquareSet((0x10000000 << 32) | 0x00000010),
  );
  ...
  static const horde = Board(
    occupied: SquareSet((0xffff0066 << 32) | 0xffffffff),
    promoted: SquareSet.empty,
    white: SquareSet(0x00000066ffffffff),
    black: SquareSet(0xffff000000000000),
    pawns: SquareSet((0x00ff0066 << 32) | 0xffffffff),
