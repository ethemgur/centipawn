...
extension type const SquareSet(int value) {
  ...
  const SquareSet.fromFile(File file)
      : value = ((0x01010101 << 32) | 0x01010101) << file,
  ...
  // Values below are written as (high32 << 32) | low32 rather than a single
  // 16-digit hex literal: dart2js/dart2wasm reject integer literals that
  // can't be represented exactly as a JS double (> 2^53), which several of
  // these full 64-bit bitboard masks exceed.
  static const empty = SquareSet(0);
  static const full = SquareSet((0xffffffff << 32) | 0xffffffff);
  static const lightSquares = SquareSet((0x55AA55AA << 32) | 0x55AA55AA);
  static const darkSquares = SquareSet((0xAA55AA55 << 32) | 0xAA55AA55);
  static const diagonal = SquareSet((0x80402010 << 32) | 0x08040201);
  static const antidiagonal = SquareSet(0x0102040810204080);
  static const corners = SquareSet((0x81000000 << 32) | 0x00000081);
  static const center = SquareSet(0x0000001818000000);
  static const backranks = SquareSet((0xff000000 << 32) | 0x000000ff);
  static const firstRank = SquareSet(0xff);
  static const eighthRank = SquareSet(0xff00000000000000);
  static const aFile = SquareSet((0x01010101 << 32) | 0x01010101);
  static const hFile = SquareSet((0x80808080 << 32) | 0x80808080);
  ...
  SquareSet flipVertical() {
    const k1 = (0x00FF00FF << 32) | 0x00FF00FF;
  ...
  SquareSet mirrorHorizontal() {
    const k1 = (0x55555555 << 32) | 0x55555555;
    const k2 = (0x33333333 << 32) | 0x33333333;
    const k4 = (0x0f0f0f0f << 32) | 0x0f0f0f0f;
...
int _popcnt64(int n) {
  return _popcnt32(n & 0xffffffff) + _popcnt32((n >>> 32) & 0xffffffff);
}
